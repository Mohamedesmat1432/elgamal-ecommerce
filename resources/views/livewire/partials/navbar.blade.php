                ...
                <div id="navbar-collapse-with-animation"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a wire:navigate
                                class="font-medium {{ request()->is('items') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="{{ route('items') }}">
                                {{__('site.products')}}
                            </a>
                            ...
                            <a wire:navigate
                                ...
                                <span class="mr-1">{{__('site.cart')}}</span>
                                <span
                            ...
                            @guest
                                <div class="py-2 md:py-1">
                                    <a wire:navigate
                                        class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent {{ request()->is('login') ? 'bg-blue-600' : 'bg-gray-500' }} text-white hover:bg-gray-400 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="{{ route('login') }}">
                            ...
                            @auth
                                <div
                                    class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:click] md:py-4 py-2">
                                    <button type="button"
                                    ...
                                    <div
                                        ...
                                        <a wire:navigate
                                            class="flex items-center {{ request()->is('my-orders') ? 'bg-blue-500 text-gray-100' : 'hover:bg-gray-100 text-gray-800' }} gap-x-3.5 py-2 px-3 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
